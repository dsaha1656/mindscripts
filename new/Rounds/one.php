...
<div class="stepwizard col-md-offset-3">
  ...
  <form role="form" action="one.php" method="post">
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            <input maxlength="100" type="text" required="required" name="1" class="form-control" placeholder="Answer">
          </div>
    ...
    <div class="row setup-content" id="step-2">
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          <h3>2.How do you handle a challenge? Give an example.</h3>
          <div class="form-group">
         
            <input maxlength="200" type="text" name="2" required="required" class="form-control" placeholder="Answer">
          </div>
    ...
    <div class="row setup-content" id="step-3">
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          <h3> 3. Have you ever made a mistake? How did you handle it? </h3>
          <div class="form-group">
            
            <input maxlength="100" type="text" name="3" required="required" class="form-control" placeholder="Answer">
          </div>
...
<div class="row setup-content" id="step-4">
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          <h3>4. Give an example of how you set goals. </h3>
          <div class="form-group">
            
            <input name="4" maxlength="100" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input name="5" maxlength="100" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" name="6" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" name="7" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" name="8" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" name="9" type="text" required="required" class="form-control" placeholder="Answer">
          </div>
      ...
      <div class="col-xs-6 col-md-offset-3">
        <div class="col-md-12">
          ...
          <div class="form-group">
            ...
            <input maxlength="100" type="text" name="10" required="required" class="form-control" placeholder="Answer">
          </div>
